...
<div id="offerModal" class="modal animated bounceIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <!-- dialog -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true" class="d-none d-lg-block d-md-block">&#10005;</span>
          <span aria-hidden="true" class="d-lg-none d-md-none">&#8249;</span>
        </button>
      </div>
      <!-- header -->
